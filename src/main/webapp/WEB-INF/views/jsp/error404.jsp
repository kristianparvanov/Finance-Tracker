		...
		<section class="content">
      		<div class="row">
			    ...
			    <div class="col-md-4" style="vertical-align:middle; text-align:right">
			    	 <h1 class="headline text-yellow" style="font-size: 65px">Oops!</h1>
			    	 <h1 class="headline text-yellow" style="font-size: 60px">Something went wrong!</h1>
			    </div>
			    <div class="col-md-4" style="vertical-align:middle; ">
			    	 <div class="error-content">
				          <h3 style="font-size: 35px"><i class="fa fa-warning text-yellow"></i> Either you can't type or we broke something.</h3>
						  <h4 style="font-size: 25px">The page you requested could not be found.</h4>
